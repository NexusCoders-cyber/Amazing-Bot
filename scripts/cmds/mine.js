...
export default {
    config: {
        ...
        author: 'Raphael Ilom',
        version: '2.0',
        shortDescription: 'Go mining to earn coins (2hr cooldown)',
        category: 'economy',
        coolDown: 3,
        role: 0,
    ...
    async onStart({ sender, reply }) {
        ...
        if (!found) { saveEco(sender, { lastMine: Date.now() }); return reply('⛏️ You dug for hours but found nothing valuable.'); }
