...
### 🎉 **ILOM Bot v2 — Major Rewrite Release!** 🎉
...
### ✨ v2.0.0 Enhancements
- ✅ **ILOM Bot Rebranding** - Full ILOM identity, no legacy naming
- ✅ **Rainbow ASCII Banner** - Gradient terminal banner on every boot
- ✅ **Telegram Pairing Bot** - Pair WhatsApp via `/pair` in Telegram
- ✅ **507+ Commands** - Expanded from 142 to 507+ commands
- ✅ **Non-TTY Compatible** - Works on panels without interactive stdin
- ✅ **≤512MB RAM** - Heavy deps removed, canvas loads on-demand
...
- 📱 **Telegram Pairing** - No QR scan needed on panels
- 🛡️ **Enterprise-Grade Security**
- 🤖 **Multi-AI Integration** (GPT, Gemini, Groq)
...
<img src="https://img.shields.io/badge/Deploy%20to-Koyeb-121212?style=for-the-badge&logo=koyeb&logoColor=white" alt="Koyeb"><br>
<b>🚀 Recommended</b><br>
<sub>24/7 Uptime</sub>
</a>
</td>
...
<img src="https://img.shields.io/badge/Deploy%20to-Railway-0B0D0E?style=for-the-badge&logo=railway&logoColor=white" alt="Railway"><br>
<b>⚡ Fast</b><br>
<sub>Auto Deploy</sub>
</a>
</td>
...
<img src="https://img.shields.io/badge/Deploy%20to-Render-46E3B7?style=for-the-badge&logo=render&logoColor=white" alt="Render"><br>
<b>🎯 Reliable</b><br>
<sub>Free Tier</sub>
</a>
</td>
...
<img src="https://img.shields.io/badge/Deploy%20to-Heroku-430098?style=for-the-badge&logo=heroku&logoColor=white" alt="Heroku"><br>
<b>💪 Classic</b><br>
<sub>Enterprise</sub>
</a>
</td>
...
**2️⃣ Create Koyeb account** at [koyeb.com](https://www.koyeb.com)
...
**6️⃣ Deploy** - Click "Deploy" and wait 2-3 minutes
...
**1️⃣ Create Render Account** at [render.com](https://render.com)
...
![Bot Features Dashboard](./attached_assets/stock_images/digital_features_das_94b4fbc4.jpg)
...
**Total: 507+ Commands** loaded and tested!
...
<td align="center" width="33%">
<b>🔄 Update</b><br>
<code>npm run update</code><br>
Smart update system
</td>
<td align="center" width="33%">
<b>📊 Database</b><br>
<code>npm run migrate</code><br>
Run migrations
</td>
<td align="center" width="33%">
<b>🔍 Logs</b><br>
...
**Method 2: Pairing Code (Terminal)**
```bash
...
**Method 4: Telegram Bot (Recommended for panels)**
...
```
4. Restart bot, then send `/pair 2547XXXXXXXX` to your bot
5. Enter the 6-digit code in WhatsApp → Linked Devices
...
<tr>
<td align="center">
<img src="https://github.com/NexusCoders-cyber.png" width="150px" style="border-radius: 50%"><br>
<b>Ilom</b><br>
...
### Version 2.0.0 (Current) — ILOM Bot v2

**🚀 Major Rewrite Release**
- ✨ 507+ commands across 9 categories
- 🌈 Rainbow gradient ASCII banner on boot
- 🤖 Multi-AI integration (GPT, Gemini, Groq)
- 📱 Telegram bot pairing — pair WhatsApp via Telegram
- ⚡ Non-TTY / panel compatible — works on Koyeb, Railway, Render, Pterodactyl
- 💾 ≤512MB RAM — puppeteer, tesseract, canvas removed from hard deps
- 🔒 Canvas graceful fallback — group events degrade cleanly without native modules
...
### 🌟 Thank You for Using ILOM Bot v2! 🌟
...
### 💝 Made with Love by Ilom & NexusCoders Team 💝
...
<p>
<b>© 2025-2026 Amazing Bot. All Rights Reserved.</b>
</p>
