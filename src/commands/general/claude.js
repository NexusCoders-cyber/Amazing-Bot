...
export default {
  config: { name: 'claude', aliases: [], author: 'Broken_vzn', version: '1.0', shortDescription: 'Chat with Claude', category: 'ai', coolDown: 3, role: 0, guide: { en: '{prefix}claude <question>' } },
  async onStart({ message, args, reply, sendImage, sendVideo }) {
if (!args[0]) return reply('🤖 Ask: `claude <question>`');
